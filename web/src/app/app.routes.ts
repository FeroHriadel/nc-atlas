...
import { AdminSightCreatePage } from './pages/admin-sight-create/admin-sight-create.page';
...
export const routes: Routes = [
    ...
    { path: 'admin/sight-create', component: AdminSightCreatePage, canActivate: [adminGuard] },
