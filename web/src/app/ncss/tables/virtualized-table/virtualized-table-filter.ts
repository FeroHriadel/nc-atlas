...
import { VirtualizedTableFilterService, FilterRow, Column } from './virtualized-table-filter.service';
...
@Component({
  ...
  templateUrl: './virtualized-table-filter.html',
  styleUrl: './virtualized-table-filter.css',
  imports: [CommonModule, Button, Select, Pill, CloseButton],
  standalone: true
})
export class VirtualizedTableFilter implements OnChanges {
  ...
  constructor(private filterService: VirtualizedTableFilterService) {}
